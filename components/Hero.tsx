        ...
        >
          ...
          <div className="flex flex-col gap-2 items-center md:items-start pl-2">
            <div className="flex items-center gap-3">
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors text-foreground">
                <Linkedin className="w-5 h-5" strokeWidth={1.5} />
              </a>
              <div className="px-3 py-0.5 rounded-full border border-blue-500/30 bg-blue-500/5 text-blue-600 dark:text-blue-400 text-xs font-semibold uppercase tracking-wider flex items-center gap-2">
